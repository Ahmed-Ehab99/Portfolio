  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop user <br className="sm:block hidden" /> interfaces and web <br className="sm:block hidden" /> applications.
          </p>
        </div>
      </div>
      <ComputersCanvas />
      <div className="absolute  bottom-4 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-12 xs:h-14 rounded-3xl border-4 border-secondary flex justify-center items-start p-2">
